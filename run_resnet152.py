    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                best_acc = epoch_acc
                best_model_wts = copy.deepcopy(model.state_dict())
                torch.save(model, 'models/resnet152-100epoch.pt')
        print()
...
# Loss function: Choose from nn.CrossEntropyLoss or FocalLoss(gamma = 2.0, alpha = 0.25)
...
torch.save(model, 'models/resnet152-100epoch-final.pt')
